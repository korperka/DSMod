/**
 * За основу взят класс из OpenSecurity, я манал доки OC
 */
...
public class OCTileEntity extends TileEntity implements ITickable, ManagedEnvironment {
    ...
    public OCTileEntity(String name) {
        super();
        componentName = name;
    }

    public OCTileEntity(String name, EnvironmentHost host) {
        isUpgrade = true;
        componentName = name;
        container = host;
        setupNode();
